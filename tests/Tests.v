...
ReadFileBytes "small.bin" As fb_full.
...
ReadFileBytes "small.bin" As fb_head Length 3.
...
ReadFileBytes "small.bin" As fb_tail Offset 4.
...
ReadFileBytes "small.bin" As fb_mid Offset 1 Length 3.
...
ReadFileBytes "small.bin" As fb_empty Offset 6 Length 0.
...
ReadFileBytes "small.bin" As fb_typed : Byte.byte.
...
ReadFileInt63 LittleEndian "small.bin" As fi_le.
...
ReadFileInt63 BigEndian "small.bin" As fi_be.
...
ReadFileString "small.bin" As fs_full.
...
ReadFileString "small.bin" As fs_mid Offset 1 Length 4.
